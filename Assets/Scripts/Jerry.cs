...
{
    public static event UnityAction<Vector2> JerryStrike;
    ...
    public void Run(Vector2 position)
    {
        ...
        runTime = Random.Range(minimalRunTime, 20f);
    ...
    {
        JerryStrike?.Invoke(transform.position);
